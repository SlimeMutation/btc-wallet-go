...
import (
	...
	"github.com/SlimeMutation/btc-wallet-go/common/bigint"
)
...
type BatchBlock struct {
	rpcClient *WalletChainBtcClient
...
func NewBatchBlock(rpcClient *WalletChainBtcClient, fromHeader *BlockHeader, confDepth *big.Int) *BatchBlock {
	return &BatchBlock{
		rpcClient:              rpcClient,
